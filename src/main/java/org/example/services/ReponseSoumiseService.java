...
public class ReponseSoumiseService {
    ...
    public void ajouterReponseSoumise(ReponseSoumise r) {
        ...
        try (PreparedStatement ps = MyDataBase.getInstance().getMyConnection().prepareStatement(req)) {
    ...
    public void ajouterReponseSoumise(int questionId, String texteSoumis) {
        ...
        try (PreparedStatement ps = MyDataBase.getInstance().getMyConnection().prepareStatement(sql)) {
            ps.setInt(1, questionId);
