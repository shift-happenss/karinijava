...
public class ReponseController {
    ...
    void ouvrirPopupAjout() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/houss/popup_ajout_reponse.fxml"));
    ...
    private void ouvrirPopupModifier(Reponse reponse) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/houss/popup_modifier_reponse.fxml"));
            Parent root = loader.load();
