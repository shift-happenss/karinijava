...
public class CoursController implements Initializable {
    ...
    public void openAddCoursPopup() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/houss/add_cours_popup.fxml"));
    ...
    private void modifierCours(Cours cours) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/houss/modifier_cours_popup.fxml"));
            Parent root = loader.load();
    ...
    private void openExamenInterface() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/houss/examen_interface.fxml"));
            Parent root = loader.load();
