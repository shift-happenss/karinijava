...
public class QuestionController {
    ...
    private void ouvrirAjout() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/houss/ajouter_question.fxml"));
    ...
    private void ouvrirModification(Question question) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/houss/modifier_question.fxml"));
            Parent root = loader.load();
    ...
    private void voirReponses(Question question) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/houss/reponses_interface.fxml"));
            Parent root = loader.load();
