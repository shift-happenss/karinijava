...
public class AfficherRessourceBackController implements Initializable {
    ...
    private void openShowRessourcePage(Ressource ressource) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/blog/showRessource.fxml"));
    ...
    private void handleCreateRessourceClick() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/blog/AjouterRessource.fxml"));
            Parent root = loader.load();
