...
public class ExamenController {
    ...
    public void openAddExamenPopup() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/addExamen_interface.fxml"));
    ...
    private void modifierExamen(Examen examen) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/modifierExamen.fxml"));
            Parent root = loader.load();
